        ...
        {playerAchievements.length === 0 ? (
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-foreground">
              Полученные достижения ({playerAchievements.length})
            </h2>
              ...
              {playerAchievements.map((playerAchievement) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className="text-4xl">{playerAchievement.achievement.icon}</div>
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between mt-3 pt-3 border-t border-border/30">
                        ...
                        <span className="text-xs text-muted-foreground">
                          Комната: {playerAchievement.achievement.roomId.slice(0, 8)}...
                        </span>
                      </div>
                    </div>
                  </div>
