              ...
              <div className="absolute inset-0 z-10 flex flex-col justify-end p-5">
                  <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2 mb-1">
                          ...
                          {race.hasLineages && (
                               <span className="text-[10px] font-bold uppercase tracking-widest text-blue-200 bg-blue-500/20 px-2 py-0.5 rounded-md backdrop-blur-sm border border-blue-500/30">
                                   Наследия
                               </span>
                          )}
                      </div>
                      ...
                      <div className="flex items-center gap-4 text-white/80 text-xs border-t border-white/10 pt-3 mt-1">
                          <div className="flex items-center gap-1.5">
                              <span className="text-white/40 font-bold uppercase">Размер</span>
                              <span className="font-mono font-bold text-white">
                                  {race.size === "Medium" ? "Сред." : race.size === "Small" ? "Мал." : "Бол."}
                              </span>
                          </div>
                          <div className="flex items-center gap-1.5">
                              <span className="text-white/40 font-bold uppercase">Ск.</span>
                              <span className="font-mono font-bold text-white">
                                  {race.speed}
                              </span>
                          </div>
