  ...
  },
  {
    ...
    subclasses: [
      ...
      },
      {
        ...
        name: "Inquisitive",
        nameRu: "Инквизитор",
        description: "Вы превосходно раскрываете секреты и разгадываете тайны.",
        features: [
          {
            name: "Ear for Deceit",
            nameRu: "Чутьё на обман",
            description:
              "Когда вы совершаете проверку Мудрости (Проницательность), чтобы определить ложь, результат проверки не может быть ниже 8 + модификатор Мудрости.",
            level: 3,
          },
        ],
      },
