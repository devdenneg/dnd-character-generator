...
export const phb2024Classes: CharacterClass[] = [
  {
    ...
    nameRu: "Варвар",
    description:
      "Для некоторых людей гнев — это просто эмоция. Для варвара это — мощь. Чистая, хаотичная сила природы, проходящая сквозь его тело с единственной целью — сокрушить врага. Варвары каждый раз выбирают ярость над хладнокровием. Они наследники некоторых древних клана, последователи тотема животного или обладатели запертой силой. Это — не просто боевой стиль, это образ жизни.",
    hitDie: 12,
  ...
  },
  {
    ...
    nameRu: "Бард",
    description:
      "Барды знают, что в каждом человеке содержится искра магии, ждущая пробуждения. Эта искра — то, что позволяет магии существовать, и барды научились высвобождать её через искусство — музыку, поэзию, танец и многое другое. Все стили боевых искусств могут быть средством выражения магии барда. Барды вдохновляют других своим примером и магией, помогая союзникам превосходить самих себя.",
    hitDie: 8,
  ...
  },
  {
    ...
    nameRu: "Жрец",
    description:
      "Жрецы — каналы божественной магии. Различные божества выбирают разные жрецов и наделяют их магией, подходящей их целям. Никогда не было двух одинаковых жрецов, так как разные божества выбирают разные людей. Священники могут исцелять раны и спасать товарищей от смерти, но они также известны как грозные воины, способные повергать врагов своего божества.",
    hitDie: 8,
  ...
  },
  {
    ...
    nameRu: "Друид",
    description:
      "Друиды святили свои жизни служению природе. Они берут опекой над дикой местностью и охраняют ее от тех, кто причиняет ей вред. Они почитают естественный цикл жизни и смерти. Их магия происходит из самой земли. Древние предания изображают друидов, принимающих облик животных или растений и использующих магию прямого из земли и переплетение ее волшебства с природой.",
    hitDie: 8,
    primaryAbility: ["wisdom"],
  ...
  },
  {
    ...
    nameRu: "Воин",
    description:
      "Воины объединяют точность, мастерство и магию с тренировкой боевых искусств. Хорошо обученные боевые техники позволяют им совершать подвиги, которые граничат с магией. Воины готовятся к бою своих жизней. Они вступают в боевые действия, вооруженные навыками, выносливостью и любовью к боевой славе.",
    hitDie: 10,
  ...
  },
  {
    ...
    nameRu: "Монах",
    description:
      "Монахи посвятили свои жизни достижению физического, умственного и духовного совершенства. Благодаря строгому обучению и дисциплине они могут канализировать их внутреннюю магию для достижения необычных результатов. Их боевые техники помогают им совершать акты движения и боевого мастерства, граничащие с магией.",
    hitDie: 8,
  ...
  },
  {
    ...
    nameRu: "Следопыт",
    description:
      "Следопыты — исследователи границ цивилизации и охотники дикой природы. Ловкие боевики, знающие как оружие, так и магию природы, они посвятили свои жизни жизни в дикой местности. Следопыты охраняют дикие земли и борются с монстрами, защищая цивилизованных людей от опасностей, скрывающихся в лесах.",
    hitDie: 10,
    primaryAbility: ["dexterity", "wisdom"],
    savingThrows: ["strength", "dexterity"],
    armorProficiencies: ["Лёгкие доспехи", "Средние доспехи", "Щиты"],
  ...
  },
  {
    ...
    nameRu: "Плут",
    description:
      "Плуты полагаются на навыки, скрытность и уязвимые места врагов, а не на боевую мощь. Они являются экспертами в контроле поля боя, использованием окружения в своих целях и нанесении точных ударов. Многие плуты полагаются на воровство, контрабанду и иные криминальные занятия. Однако, некоторые плуты используют свои таланты законным путем.",
    hitDie: 8,
  ...
  },
  {
    ...
    nameRu: "Чародей",
    description:
      "Чародеи являются носителями врожденной магии, возникающей из их самих. Чародейская магия может происходить из драконьей наследственности, дара богов, либо из самой сущности магического хаоса. Какого бы происхождения ни была их магия, чародеи обладают врожденной способностью манипулировать ею, часто инстинктивно, без обучения.",
    hitDie: 6,
    primaryAbility: ["charisma"],
  ...
  },
  {
    ...
    nameRu: "Колдун",
    description:
      "Колдун — это персонаж, который заключил пакт с потусторонней сущностью большей силы. Такая сущность может быть архидьяволом, демоном или даже небольшим божеством. Колдуны часто ищут такие пакты в надежде получить власть над другими, но конечный результат зависит от переговоров и амбиций как Колдуна, так и его покровителя.",
    hitDie: 8,
    primaryAbility: ["charisma"],
    savingThrows: ["wisdom", "charisma"],
    armorProficiencies: ["Лёгкие доспехи"],
  ...
  },
  {
    ...
    nameRu: "Волшебник",
    description:
      "Волшебники — ученые магии, имеющие доступ к магии через интеллект и изучение. Они ведут записи своих заклинаний в книгах и постоянно расширяют свои знания магии. Волшебники — это ученые, которые ищут понимание магии и ее механизмов, и своим интеллектом достигают магических результатов, которые другие могут только мечтать.",
    hitDie: 6,
